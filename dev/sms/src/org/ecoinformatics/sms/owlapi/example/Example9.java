...
//    public static final String DOCUMENT_IRI = "http://ecoinformatics.org/oboe/oboe.1.0/oboe-core.owl";
    ...
    public static void main(String[] args) {
        try {
            ...
            // class).
            IRI margheritaPizzaIRI = IRI.create(ont.getOntologyID().getOntologyIRI() + "#NamedPizza");
            //IRI margheritaPizzaIRI = IRI.create(ont.getOntologyID().getOntologyIRI() + "#Margherita");
            //IRI margheritaPizzaIRI = IRI.create(ont.getOntologyID().getOntologyIRI() + "#Measurement");
//            IRI margheritaPizzaIRI = IRI.create(ont.getOntologyID().getOntologyIRI() + "#Concentration");
