...
public class AnnotationPlugin
	...
	public static void initializeOntologies() {
		...
		//SMS.getInstance().getOntologyManager().importOntology("https://code.ecoinformatics.org/code/semtools/trunk/dev/oboe-ext/sbc/oboe-sbc.owl");
		//SMS.getInstance().getOntologyManager().importOntology("https://code.ecoinformatics.org/code/semtools/trunk/dev/oboe-ext/gce/oboe-gce.owl");
	}
