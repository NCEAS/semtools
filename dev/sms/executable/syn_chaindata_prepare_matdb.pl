...
$annotfile001 = "synchain_0.001-annot-spec.txt ";
for ($d = 1; $d <= $num001; $d++) {
...
$annotfile01 = "synchain_0.01-annot-spec.txt ";
...
$annotfile05 = "synchain_0.05-annot-spec.txt ";
...
$annotfile1 = "synchain_0.1-annot-spec.txt ";
...
$annotfile2 = "synchain_0.2-annot-spec.txt ";
...
$num5 = 1000;
#$annotfile5 = "synchain_0.5-annot.xml ";
$annotfile5 = "synchain_0.5-annot-spec.txt ";
print "0.5 ==> filenum: " . $num5 ."\n";
for ($d = 1; $d <= $num5; $d++) {
	$datafile = "synchain_0.5-n5000-d" . $d ."-data.txt ";
	$outputPrefix = "synchain_0.5-n5000-d" . $d;
	
	$curcmd = $cmd . $annotfile5 . $datafile . $outputPrefix . $dbname;
	if($d % 500==0){	
		print "$curcmd\n";
	}
	system $curcmd;
...
$annotfile_other = "synchain_other-annot-spec.txt ";
...
for ($d = 1; $d <= $num_other; $d++) {
	...
	$curcmd = $cmd . $annotfile_other . $datafile . $outputPrefix . $dbname;
	if($d % 100==0){	
		print "$curcmd\n";
	}
	system $curcmd;	
