...
Based on the goals above, our specific objectives were to produce effective semantic tools for ecological data management and to show that semantics could be leveraged to both improve search and to enable data integration for highly heterogeneous environmental data collections.  We aimed to produce several semantic tools, including:
