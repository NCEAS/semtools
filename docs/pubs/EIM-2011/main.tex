...
\author{{\large Ben Leinfelder$^1$, Shawn Bowers$^2$, Margaret O'Brien$^3$,
  Matthew B. Jones$^1$, Mark Schildhauer$^1$}
% add some space between author names and affils
  \vspace{1.6mm}\\
  %\fontsize{9}{9}%\selectfont\itshape
...
\let\thefootnote\relax\footnotetext{\includegraphics[scale=0.4]{images/cc-logo.png}~This work is licensed under a Creative Commons Attribution 3.0 Unported License (see http://creativecommons.org/licenses/by/3.0).} 
