...
The rest of this paper is organized as follows. \secref{sec:annotation}
briefly describes the various components used within our
approach. \secref{sec:framework} describes the extensions we have
developed for Morpho and Metacat to support semantic
annotation. \secref{sec:application} describes the types of data
